...
namespace EM.Migrations
{
    ...
    [Migration("20250601200143_Movimientos")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EM.Entidades.MovimientoUtileria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("IdUtileria");

                    b.ToTable("MovimientosUtilerias");
                });
            ...
            modelBuilder.Entity("EM.Entidades.MovimientoUtileria", b =>
                {
                    b.HasOne("EM.Data.ApplicationUser", "Usuario")
                        .WithMany()
                        .HasForeignKey("IdUsuario")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EM.Entidades.Utileria", "Utileria")
                        .WithMany()
                        .HasForeignKey("IdUtileria")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Usuario");

                    b.Navigation("Utileria");
                });
